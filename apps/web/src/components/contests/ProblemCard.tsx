...
// Nota: `inputHintForType` se movió a `@/lib/contests/input-hints` porque
// ProblemCard es un Client Component y la page.tsx (Server Component) no
// puede importar funciones desde client components en Next.js 15.
